System.register(['@angular/core', '@angular/router', '../core/services/data.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            CourseTestComponent = (function () {
                function CourseTestComponent(route, dataService) {
                    this.route = route;
                    this.dataService = dataService;
                }
                CourseTestComponent.prototype.ngOnInit = function () {
                    var _this = this;
                ...
                CourseTestComponent.prototype.ngOnDestroy = function () {
                    this.sub.unsubscribe();
                };
                CourseTestComponent = __decorate([
                    core_1.Component({
                        //moduleId: module.id,
                        selector: 'course-test',
                        template: "<div *ngIf=\"course\">\n                  <div class=\"row\">\n                    <h1><b>Test</b> your Knowledge on </h1>\n                </div>   \n                <div *ngIf=\"!course\" class=\"row\">\n                  No course found\n                </div>  "
                    }), 
                    __metadata('design:paramtypes', [router_1.ActivatedRoute, data_service_1.DataService])
                ], CourseTestComponent);
                return CourseTestComponent;
            }());
            exports_1("CourseTestComponent", CourseTestComponent);
        }
    }
});

//# sourceMappingURL=courseTest.component.js.map
