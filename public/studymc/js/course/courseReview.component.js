System.register(['@angular/core', '@angular/router', '../core/services/data.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            CourseReviewComponent = (function () {
                function CourseReviewComponent(route, dataService) {
                    this.route = route;
                ...
                CourseReviewComponent.prototype.ngOnDestroy = function () {
            ...
            exports_1("CourseReviewComponent", CourseReviewComponent);
        }
    }
});

//# sourceMappingURL=courseReview.component.js.map
